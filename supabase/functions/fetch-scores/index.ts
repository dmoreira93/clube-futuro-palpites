// supabase/functions/fetch-scores/index.ts - VERSÃO REVERTIDA PARA API-FOOTBALL
...
serve(async (_req) => {
  ...
  try {
    // 1. Pega a chave secreta da API-Football que você atualizou
    ...
    // Ajuste a liga (league) e a temporada (season) conforme o campeonato do seu bolão
    ...
    // 3. Retorna os dados brutos da API-Football
