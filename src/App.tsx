  ...
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      {/* CORREÇÃO APLICADA AQUI:
        BrowserRouter agora envolve o AuthProvider.
        Isso garante que o contexto de autenticação e todos os seus componentes filhos
        tenham acesso às funcionalidades de roteamento.
      */}
      <BrowserRouter>
        <AuthProvider>
          <Toaster />
