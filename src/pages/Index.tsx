...
import { Users, Volleyball as SoccerBallIcon, Flag as FlagIcon, Loader2 } from "lucide-react"; // Importado o ícone de Loader
...
const Index = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      // Não precisa setar o loading aqui, pois ele já começa como true.
      ...
      try {
        ...
        // A query da próxima partida foi mantida, pois está bem estruturada com maybeSingle()
        ...
        // Opcional: setar um estado de erro para mostrar uma mensagem na UI
      } finally {
  ...
  // ADAPTAÇÃO PRINCIPAL: Bloco de renderização condicional
  if (loadingStats) {
    return (
      <Layout>
  ...
  // O conteúdo original só é renderizado quando loadingStats é false
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            {/* Se o erro persistir, o próximo passo é comentar a linha abaixo */}
            //<RankingTable />
          </div>
          <div className="lg:col-span-1 flex flex-col gap-8">
            {/* E também comentar a linha abaixo */}
            //<NextMatches />
