  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none"> {/* Usa classes 'prose' do Tailwind para formatação */}
        ...
        <p>
          Não compartilhamos suas informações pessoais identificáveis com terceiros.
        </p>
        ...
        <h2>6. Contato</h2>
        <p>
          Se você tiver alguma dúvida sobre esta Política de Privacidade, entre em contato conosco: contato@clubefuturo.com.
        </p>
      </div>
    </div>
  );
