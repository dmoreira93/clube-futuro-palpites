...
import { UserX, Search, Shield, User, Calendar, CheckCircle2, Loader2, Users } from "lucide-react";
...
const AdminUsers = () => {
  ...
  const handleDelete = async (userId: string) => {
    try {
      ...
      // Se houver tabela de palpites relacionada, ajuste aqui (geralmente cascade resolve)
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <p className="text-muted-foreground text-sm">Administre os participantes cadastrados na plataforma.</p>
        </div>
        ...
        <CardHeader className="pb-4 border-b border-gray-100">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <CardDescription>Total: {filteredUsers.length} usuários encontrados.</CardDescription>
                </div>
            </div>
        </CardHeader>
                    ...
                    <Table>
                        <TableHeader className="bg-gray-50/80">
                            <TableRow>
                                ...
                                <TableHead className="font-bold text-fifa-blue">Tipo de Conta</TableHead>
                                <TableHead className="font-bold text-fifa-blue">Primeiro Acesso</TableHead>
                                <TableHead className="font-bold text-fifa-blue">Data de Cadastro</TableHead>
                                ...
                                <TableRow key={user.id} className="hover:bg-blue-50/30 transition-colors h-16 group">
                                    ...
                                    <TableCell>
                                        {user.first_login ? (
                                            ...
                                            <div className="flex items-center text-green-600 text-sm gap-1">
                                                <CheckCircle2 className="w-4 h-4" /> <span className="text-gray-600">Confirmado</span>
                                            </div>
                                        )}
                                    </TableCell>
                                    ...
                                    <AlertDialog>
                                        ...
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription>
                                            Tem certeza que deseja excluir o usuário <strong className="text-gray-800">{user.name}</strong>?
                                            <br/><br/>
                                            Esta ação é irreversível e removerá todos os palpites e histórico associados a este usuário.
                                            </AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
